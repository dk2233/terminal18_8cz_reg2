...
;dodano sterowanie drugim obwodem
;rozszerzono menu o kolejne opcje - związane z operacją pracy regulatora drugiego
...
procek = 18f4320
        ...
        include  "p18f4320.inc"
         ...
         ; CONFIG FSCM=ON, IESO=OFF, OSC=XT, PWRT=ON, BOR=OFF, BORV=27, WDT=OFF, CCP2MX=OFF ,PBAD = DIG, MCLRE = ON, DEBUG=ON, LVP=OFF
         CONFIG FSCM=ON, IESO=OFF, OSC=XT, PWRT=ON, BOR=ON, BORV=27, WDT=OFF, CCP2MX=OFF ,PBAD = DIG, MCLRE = ON, DEBUG=OFF, LVP=OFF
         ; CONFIG1H, _IESO_OFF_1H & _XT_OSC_1H 
...
wykryto_low_voltage
        ;wylaczam wszystko co niepotrzebnie pobiera prad
         clrf  EECON1
         clrf   PIE1
         clrf   PIE2
         clrf   INTCON
         ...
         ; goto    mala_petla
;zapisuje do EEPROM
         LFSR    FSR1,ile_kanalow
             
;adres pod ktorym zapisuje w EEprom odpowiada adresom w pamieci danych         
petla_zapisu
         ; movlw    ktory_czujnik_reguluje2+1
         movlw   histereza_R2_2+1
         ;okazuje sie ze bez bledow zapisuje najczesciej tylko 11 bajtow
         xorwf    FSR1L,w
         btfsc    STATUS,Z
         goto     mala_petla
;czytam adres z FSR
         ...
         goto     petla_zapisu          
mala_petla
;zwiekszam o jeden rejestr wlaczen do zrobienia w przyszlosci
...
;wszystkie 
      ...
      bsf   markers3,czy_zegar_wyswietlac
         ...
         ; movlw    0
         ; movwf    jaka_wartosc_regulujeH1
         ; movlw    0x80
         ; movwf    jaka_wartosc_regulujeL1
         
         ; movlw    0
         ; movwf    jaka_wartosc_regulujeH2
         ; movlw    0x80
         ; movwf    jaka_wartosc_regulujeL2
         
         ; movlw    2
         ; movwf    histereza_R1_1
         
         ; movlw    2
         ; movwf    histereza_R1_2
         
         ; movlw    1
         ; movwf    histereza_R2_1
         
         ; movlw    1
         ; movwf    histereza_R2_2
...
;z poziomu menu można zmienić te znaczniki tak by nie nastąpiło ponowne wyświetlanie zegara i temperatur
         movlw    0
         movwf    ktory_czujnik_reguluje1
         movwf    ktory_czujnik_reguluje2
         movwf    czy_reguluje1
         movwf    czy_reguluje2
...
odczytuje_opcje_z_eeprom
      clrf      EECON1
      movlw     ile_kanalow
      movwf      FSR0L
      clrf       FSR0H
      
petla_odczytuje_opcje_z_eeprom
      ...
      xorwf      FSR0L,w
      btfss      STATUS,Z
      goto        petla_odczytuje_opcje_z_eeprom

      
      
;jeslie odczytano z eepromu 0xff to wpisz wartosc  defaulotowa    
      
      LFSR        FSR0,ile_kanalow
      movlw       HIGH tab_poprawnych_nastaw
      movwf       TBLPTRH
      
      movlw       LOW tab_poprawnych_nastaw
      movwf       TBLPTRL
...
petla_spr_nastaw      
      ...
      movlw     0xff
      cpfseq    INDF0
      goto      petla_spr_nastaw_dalej
      
      goto      ustaw_opcje_standartowe
      
petla_spr_nastaw_dalej      
      movlw     0x00
      cpfseq    INDF0
      goto      petla_spr_nastaw_dalej2
      
ustaw_opcje_standartowe      
      TBLRD       *
      movf        TABLAT,w
      movwf     INDF0
      
petla_spr_nastaw_dalej2   
        incf    TBLPTRL,f
        btfsc   STATUS,Z
        incf    TBLPTRH,f
      ...
      movlw     histereza_R2_2+1
      cpfseq    FSR0L
      goto      petla_spr_nastaw
      
      
      goto      sprawdz_pierwsza_nastawe
      
      ;nastawy poprawne jesli bylo w eeprom 0xff
tab_poprawnych_nastaw
        db      0x00,0x20,0x80,0,0xa0,0,0xa0,2,2,2,2,0,0,0,0
     


;jezeli jaka_wartosc_regulujeH1 lub jaka_wartosc_regulujeH2
;sa wieksze od 1 to wyzeruj

sprawdz_pierwsza_nastawe
        movlw   0x01
        cpfsgt jaka_wartosc_regulujeH1
        goto    sprawdz_druga_nastawe
        
        clrf    jaka_wartosc_regulujeH1
        
sprawdz_druga_nastawe        
        movlw   0x01
        cpfsgt jaka_wartosc_regulujeH2
        goto    ustawienia_low_voltage
     
        clrf    jaka_wartosc_regulujeH2
     
ustawienia_low_voltage
        movlw   b'00011100'
        movwf   LVDCON
        
ustawienia_low_voltage_loop
        btfss   LVDCON,IRVST
        goto    ustawienia_low_voltage_loop
        ...
        call           ustaw_wartosc_dziel_usredniania
        movlw       1
...
napisz_czas
     ...
     ;jezeli po tej operacji jest 0 w W to znczy ze 
     ;przedtem obydwa te bajty zawieraly 0
     
     movf       czy_reguluje1,w
     iorwf      czy_reguluje2,w
     bnz        napisz_czas_litera_r
nie_pisz_litery_r
     movlw  _puste 
     goto   napisz_czas_dalej1 
     
napisz_czas_litera_r     
     movlw  _r
     
napisz_czas_dalej1     
     ; btfsc  markers_regulacja,reguluj1
     ; movlw  _r
     
     ; btfsc  markers_regulacja,reguluj2
     ; movlw  _r
...
wylacz_pomiary
      bcf   markers,czy_wysylac_pomiary_serial
         ...
         bcf      markers_regulacja,reguluj2
         bcf      markers_regulacja,reguluj1
         ;bcf      markers2,
...
ustaw_wartosc_dziel_usredniania         
...
rozkaz_rejestracji_poprawki_temp
      ;incf     FSR0L,f   
      call     kopiuj_liczbe_przeslana
...
;*p - poprawka  czujnika temperatury i o ile np: *p0009 czyli 0 o 9 (ujemne to uzupelnienia czyli *p00fe to poprawka o -1
         ...
         xorwf    INDF0,w
         btfsc    STATUS,Z
         goto     rozkaz_rejestracji_poprawki_temp
...
wyswietl_cyfry_temperatury_opcje  
...
zapis_do_pamieci_temperatury  
      ...
      ;jezeli tak to nie sprawdzaj przekroczenia
        btfsc     INDF1,7
        goto      zapisz_do_pam_nie_spr_przekrocz
         ;jezeli przekroczylem to
         
         btfsc    STATUS,C
         incf     pomiarH,f
         
zapisz_do_pam_nie_spr_przekrocz
...
bez_wyswietlania_pradu2
      ...
      goto     spr_czy_mam_dalej_mierz_prad
...
;jezeli ostatni kanal to wyslij wszystkie, jezeli nie ostatni to zmierz kolejny
 ...
 ;jezeli to nie aktualny czujnik to dalej nie sprawdzaj 
 
         movf    ktory_czujnik_reguluje1,w
         cpfseq   ktory_kanal
         goto           procedura_regulacji_dwu_2
        ...
        ;jezeli jest 1 
         ...
         xorlw    1
         btfsc    STATUS,Z
         goto     procedura_regulacji_dwu_grzanie1
         ...
         xorlw    2
         btfsc    STATUS,Z
         goto     procedura_regulacji_dwu_cool1
         
         
         
         
         
procedura_regulacji_dwu_grzanie1
...
;porownaj wartosc pomierzona z zadana
         ...
         movf     jaka_wartosc_regulujeH1,w
...
;        
         btfss    markers_regulacja,wylacz_moc1
         bsf      markers_regulacja,zalacz_moc1
...
regulacja_dwu_moc_OFF         
         ...
         ;histereza dolna
         movf     histereza_R1_2,w
         subwf     jaka_wartosc_regulujeL1,w
...
regulacja_dwu_moc_ON
         ...
         ;histereza górna
         movf     histereza_R1_1,w
         addwf    jaka_wartosc_regulujeL1,w
...
;sprawdz czy to samo czy wieksze
         btfsc    STATUS,Z
         goto     sa_rowne_sprawdz_Lbajt_cool
...
;jezeli jest wlaczona energia to dodaj wartosc histerezy tj wylacza pozniej
         ;btfsc    latch_moc,lampka2
         btfsc    port_triak,triak1
         goto     regulacja_dwu_moc_cool_ON
         
         
regulacja_dwu_moc_cool_OFF         
         ;jeżeli moc jest wyłączona w tej chwili to włącz ją dopiero gdy 
         ;pomiar będzie wiekszy niż temperatura zadana 
...
; jeżeli po odjęciu jest C w Statusie, tzn że pomiarL > pomiaru+histerezy
...
regulacja_dwu_moc_cool_ON
         ;jeżeli moc jest włączona w tej chwili to wyłącz ją dopiero gdy 
         ;pomiar będzie mniejszy niż temperatura zadana - histereza zadana
...
;sprawdz czy to samo czy wieksze, jesli jest wieksze to C ustawione
         btfsc    STATUS,Z
         goto     regulacja_dwu_moc_ON_wylacz_cool
...
regulacja_dwu_moc_ON_wylacz_cool
         bsf      markers_regulacja,wylacz_moc1
         goto     procedura_regulacji_dwu_2                         
...
wykonano_pom_wszystkich_kanalow
;jezeli juz skonczylem wszystkie mierzyc to sprawdz czy mam wlaczyc grzanie
;jezeli ustawiono bit o nie wlaczaniu to olej
         
         movf    czy_reguluje1,w         
         bz     powlaczaj_moc_reg2
         
         btfsc    markers_regulacja,wylacz_moc1
         goto    wylaczam_moc
         
         btfss    markers_regulacja,zalacz_moc1
         goto    wylaczam_moc
...
koncz_z_moca
         bcf      markers_regulacja,zalacz_moc1
         bcf      markers_regulacja,wylacz_moc1
...
powlaczaj_moc_reg2         
         ...
         btfsc    markers_regulacja,wylacz_moc2
         goto    wylaczam_moc2
         
         btfss    markers_regulacja,zalacz_moc2
         goto    wylaczam_moc2
         
         btfss    port_triak,triak2
         bsf      port_triak,triak2
...
koncz_z_moca2
         bcf      markers_regulacja,zalacz_moc2
         bcf      markers_regulacja,wylacz_moc2
...
zmierz_nast_czujnik_temperatury
...
;jeżeli zaznaczono że upłynął czas oczekiwania to wybierz procedurę zmiany      
      ...
      goto        ustaw_spr_szybkiej_zmiany
...
;opcja_ustaw_temp
      ...
      movlw       opcja_odstep
      cpfseq      numer_opcji
      goto        sprawdz_czy_wlacz_szybka_zmiane2

      goto        ustaw_spr_szybkiej_zmiany
      
sprawdz_czy_wlacz_szybka_zmiane2      
      movlw       opcja_ustaw_temp_R1
      cpfseq      numer_opcji
      goto        sprawdz_czy_wlacz_szybka_zmiane3

      goto        ustaw_spr_szybkiej_zmiany
      
sprawdz_czy_wlacz_szybka_zmiane3
      movlw       opcja_ustaw_temp_R2
      cpfseq      numer_opcji
      goto        sprawdz_czy_wlacz_szybka_zmiane4

      goto        ustaw_spr_szybkiej_zmiany
      
sprawdz_czy_wlacz_szybka_zmiane4
      goto  wlacz_przerwanie_tmr3
 
; ustaw_sprawdzanie_szybkiej_zmiany
ustaw_spr_szybkiej_zmiany
...
wykryto_down
      ...
      movf        pozycja_menu,w
      bnz         wyk_down_spr_czy_wys_kolej_opcje
...
wyk_down_spr_czy_wys_kolej_opcje
...
; i nalezy zmienic pozycje_menu oraz wyswietlic opcje menu z kolejnego ekranu
      ...
      goto         wykryto_down_zmiana_pol_gwiazdki
      ...
      goto        wyk_down_wyswietl_opcje_tabl_2
      
      btfsc       pozycja_menu,menu_opcje3
      goto        wykryto_down_wys_opcje_tab_trzy
      
      btfsc       pozycja_menu,menu_opcje4
      goto        wykryto_down_wysw_opcje_tab_4

      btfsc       pozycja_menu,menu_opcje5
      goto        wykryto_down_wysw_opcje_tab_5
...
wyk_down_wyswietl_opcje_tabl_2
...
wykryto_down_wys_opcje_tab_trzy
...
; wykryto_down_wyswietl_opcje_tablicy_piata
wykryto_down_wysw_opcje_tab_5
      movlw       HIGH tablica_piata
      movwf       TBLPTRH
      
      movlw       LOW tablica_piata
      movwf       TBLPTRL
...
wykryto_down_zmiana_pol_gwiazdki
...
;;;; numer opcji odpowiada polozeniu opcji w MENU      
...
wykryto_down_zmiana_opcji
      ...
      cpfseq      ile_kanalow
      goto         wykr_down_zmian_opcji_wysw_kanal
      
      movlw       8
      movwf       ile_kanalow
      
; wykryto_down_zmiana_opcji_wyswietl_kanaly
wykr_down_zmian_opcji_wysw_kanal
      call     check_busy
      movlw    linia_gorna
      addlw       polozenie_liczby_menu
      call      send
      ;
      call     check_busy
      movf        ile_kanalow,w
...
;czyli zawartość rejestru jest zamieniana na postać dziesiętną i przenoszonona do dec100 dec10 dec1
      ...
      call        wykr_enter_gdzie_wysw_licz_bajt
...
wykryto_down_sprawdz_3  
      ...
      movlw       0x1
      cpfseq      jak_duzo_probek
      goto        wykryto_down_spr_3_zmni_probki
...
wykryto_down_spr_3_zmni_probki
;dziele przez 2
      movlw       0x80 
...
wykryto_down_sprawdz_5
      ...
      decf        jaka_wartosc_regulujeL1,f
      
      btfsc       STATUS,C
      goto        wykryto_down_sprawdz_5_zero
      ;jeżeli w H jest 0 to  umieść tam 1
      movf       jaka_wartosc_regulujeH1,w
      bz          wykryto_down_spr_5_zawracanie
      
      decf        jaka_wartosc_regulujeH1,f
      
      btfsc       STATUS,C
      goto        wykryto_down_sprawdz_5_zero
; wykryto_down_sprawdz_5_zawracanie
wykryto_down_spr_5_zawracanie
      movlw       1
      movwf       jaka_wartosc_regulujeH1
...
wykryto_down_sprawdz_6
      ...
      decf        jaka_wartosc_regulujeL2,f
      
      btfsc       STATUS,C
      goto        wykryto_down_sprawdz_6_zero
      ;jeżeli w H jest 0 to  umieść tam 1
      movf       jaka_wartosc_regulujeH2,w
      bz          wykryto_down_spr_6_zawracanie
      
      decf        jaka_wartosc_regulujeH2,f
      
      btfsc       STATUS,C
      goto        wykryto_down_sprawdz_6_zero
wykryto_down_spr_6_zawracanie
      movlw       1
      movwf       jaka_wartosc_regulujeH2
      
wykryto_down_sprawdz_6_zero      
                      
      call  wyswietl_temp_w_opcjach2
      
      goto        wykryto_down_exit
      
      
wykryto_down_sprawdz_7      
      
      
wykryto_down_sprawdz_9
;histereza górna

      movlw       opcja_histereza_R1_1
      cpfseq      numer_opcji
...
;histereza dolna
      movlw       opcja_histereza_R1_2
      cpfseq      numer_opcji
      goto        wykryto_down_sprawdz_11
      
      
      decf        histereza_R1_2,f
...
;histereza dolna
      movlw       opcja_histereza_R2_1
      cpfseq      numer_opcji
      goto        wykryto_down_sprawdz_12
      
      decf        histereza_R2_1,f
...
wykryto_down_sprawdz_12
;histereza dolna
      movlw       opcja_histereza_R2_2
      cpfseq      numer_opcji
      goto        wykryto_down_sprawdz_13
      
      decf        histereza_R2_2,f
...
wykryto_down_sprawdz_13
      movlw       opcja_regulacja1
      cpfseq      numer_opcji
      goto        wykryto_down_sprawdz_14
      
      
      decf        czy_reguluje1,f
      
      btfsc       STATUS,C
      goto        wykryto_down_sprawdz_13_zero
      ;jeżeli w H jest 0 to  umieść tam 1
      movlw      max_procedury_regu-1
      movwf      czy_reguluje1
      
wykryto_down_sprawdz_13_zero      
      
      

      ; movlw     czy_reguluje1
      ; movwf     FSR2
      lfsr      FSR2,czy_reguluje1
      call      wyswietl_opcje_regulacji

      
      goto        wykryto_down_exit   


wykryto_down_sprawdz_14
        movlw       opcja_regulacja2
      cpfseq      numer_opcji
      goto        wykryto_down_sprawdz_15
      
      
      decf        czy_reguluje2,f
      
      btfsc       STATUS,C
      goto        wykryto_down_sprawdz_14_zero
      ;jeżeli w H jest 0 to  umieść tam 1
      movlw      max_procedury_regu-1
      movwf      czy_reguluje2
      
wykryto_down_sprawdz_14_zero      
      
      

      ; movlw     czy_reguluje2
      ; movwf     FSR2
      lfsr      FSR2,czy_reguluje2
      call      wyswietl_opcje_regulacji
...
wykryto_down_sprawdz_15
;czujnik regulatora

      movlw       opcja_czujnik_regulacji1
      cpfseq      numer_opcji
      goto        wykryto_down_sprawdz_16
      ...
      movf        ktory_czujnik_reguluje1,w
      btfss       STATUS,Z
      goto        wykryto_down_spr15_nie_ma_zero
      
      movlw       ilosc_czujnikow
      
      movwf       ktory_czujnik_reguluje1
      
      goto        wykryto_down_sprawdz15_show
wykryto_down_spr15_nie_ma_zero      
      decf        ktory_czujnik_reguluje1,f
      

wykryto_down_sprawdz15_show
      movf        ktory_czujnik_reguluje1,w
      movwf       tmp_hex
...
;czujnik regulatora
      ...
      movlw       opcja_czujnik_regulacji2
      cpfseq      numer_opcji
      goto        wykryto_down_sprawdz_17
      ...
      movf        ktory_czujnik_reguluje2,w
      btfss       STATUS,Z
      goto        wykryto_down_spr16_nie_ma_zero
      
      movlw       ilosc_czujnikow
      
      movwf       ktory_czujnik_reguluje2
      
      goto        wykryto_down_sprawdz16_show
; wykryto_down_sprawdz16_nie_ma_zero
wykryto_down_spr16_nie_ma_zero      
      decf        ktory_czujnik_reguluje2,f
      

wykryto_down_sprawdz16_show
      movf        ktory_czujnik_reguluje2,w
      movwf       tmp_hex
...
wykryto_down_sprawdz_20
      movlw       opcja_ustaw_zegar
      cpfseq      numer_opcji
      goto        wykryto_down_sprawdz21
...
wykryto_down_sprawdz_11_4            
      ...
      call        proc_wyswietl_kolej_liczb_zegara
...
wykryto_up
      ...
      movf        pozycja_menu,w
      bnz         wyk_up_spr_czy_wyswi_kol_opcje
;jezeli pozycja menu ==0 to po nacisnieciu klawisza zmien wskazania temperatury
...
wyk_up_spr_czy_wyswi_kol_opcje
      ;movlw       1
      ;cpfseq      pozycja_menu
...
; i następuje przeskok do ekranu menu 0 lub 1 
      ...
      btfss       STATUS,Z
      goto         wykryto_up_zmiana_polozeni_gwiaz
      ...
      goto        wykr_up_wyswietl_opcje_tabl_end
...
;jeżeli będzie więcej ekrnów opcji menu, to tu należy dodać procedurę wykrywania adres której tablicy jest używany do wyświetlania opcji
      ...
      goto        wykr_up_wysw_opcje_tab_pierwsza
      
      
      btfsc       pozycja_menu,menu_opcje2 ;(tj zaznaczony jet bit wskazujący na pokazywanie opcji ekranu 1, czyli przeskok do ekranu 0)
      goto        wyk_up_wyswietl_opcje_tabl_dwa

      btfsc       pozycja_menu,menu_opcje3 ;(tj zaznaczony jet bit wskazujący na pokazywanie opcji ekranu 1, czyli przeskok do ekranu 0)
      goto        wykr_up_wyswietl_opcje_tab_trzy
      
      btfsc       pozycja_menu,menu_opcje4 ;(tj zaznaczony jet bit wskazujący na pokazywanie opcji ekranu 1, czyli przeskok do ekranu 0)
      goto        wykr_up_wysw_opcje_tabli_cztery
      

      btfsc       pozycja_menu,menu_opcje5 
      ;(tj zaznaczony jet bit wskazujący na pokazywanie opcji ekranu 1, czyli przeskok do ekranu 0)
      goto        wykr_up_wyswietl_opcje_tabl_5
      
      
      
      
; wykryto_up_wyswietl_opcje_tablicy_pierwsza
wykr_up_wysw_opcje_tab_pierwsza
      movlw       HIGH tablica_pierwsza
      movwf       TBLPTRH
...
wyk_up_wyswietl_opcje_tabl_dwa
...
wykr_up_wyswietl_opcje_tab_trzy
...
; wykryto_up_wyswietl_opcje_tablicy_cztery
wykr_up_wysw_opcje_tabli_cztery
...
wykr_up_wyswietl_opcje_tabl_end      
; wykryto_up_wyswietl_opcje_tablicy_piata
wykr_up_wyswietl_opcje_tabl_5
...
wykryto_up_zmiana_polozeni_gwiaz
...
;sprawdz którą opcję zmieniam
      ...
      cpfseq      ile_kanalow
      goto         wykr_up_zmiana_opcji_wysw_kanaly
      
      clrf              ile_kanalow

; wykryto_up_zmiana_opcji_wyswietl_kanaly
wykr_up_zmiana_opcji_wysw_kanaly
...
;numery opcji odpowiadają położeniu opcji w menu
...
wykryto_up_sprawdz_3
      ...
      movlw       0x80
      cpfseq      jak_duzo_probek
      goto        wykryto_up_spr_3_zwieksz_probki
...
wykryto_up_spr_3_zwieksz_probki
      bsf      markers,czy_usrednianie
      movlw       0x02
      mulwf       jak_duzo_probek
      movf        PRODL,w
...
wykryto_up_sprawdz_5
      ...
      incf        jaka_wartosc_regulujeL1,f
      
      bnc         wykryto_up_sprawdz_5_dalej
      ;czy  przekroczono 0x200
            
      incf        jaka_wartosc_regulujeH1,f
      
      movlw       0x02
      cpfseq      jaka_wartosc_regulujeH1
...
wykryto_up_sprawdz_6
         ...
         movlw       opcja_ustaw_temp_R2
      cpfseq      numer_opcji
      goto        wykryto_up_sprawdz_7
      
            
      incf        jaka_wartosc_regulujeL2,f
      
      bnc         wykryto_up_sprawdz_6_dalej
      ;czy  przekroczono 0x200
            
      incf        jaka_wartosc_regulujeH2,f
      
      movlw       0x02
      cpfseq      jaka_wartosc_regulujeH2
      goto        wykryto_up_sprawdz_6_dalej
...
;dolna histereza 
      movlw       opcja_histereza_R2_2
      cpfseq      numer_opcji
      goto        wykryto_up_sprawdz_13
      
      ;wlacz pomiar pradu
      ;jako test wlacz podswietlenie lub je wylacz
      
      ;btg   portlampka2,lampka2
      incf        histereza_R2_2,f
...
wyswietl_opcje_regulacji      
;jezeli jest 1 to wyswietl h
        ;jezeli jest 2 to wyswietl c
        ;jezeli jest 0 to wyswietl 0

      
        movlw   1
        cpfseq   INDF2
        goto    wyswietl_opcje_regulacji1
        
        movlw   _h-0x30
        movwf       dec100
        
wyswietl_opcje_regulacji1        
        movlw   2
        cpfseq   INDF2
        goto    wyswietl_opcje_regulacji2
...
wyswietl_opcje_regulacji2      
       movlw    0
       cpfseq   INDF2
       goto     wyswietl_opcje_regulacji3
       
      movlw     0
      movwf       dec100
      
      ;jesli juz wylaczam to wylacz triaki
      movlw     czy_reguluje1
      cpfseq    FSR2L
      goto      spr_czy_wylaczyc_triak
      
      bcf       port_triak,triak1
      goto      wyswietl_opcje_regulacji3
spr_czy_wylaczyc_triak
        movlw     czy_reguluje2
      cpfseq    FSR2L
      goto      wyswietl_opcje_regulacji3
...
wykryto_up_sprawdz_13
      movlw       opcja_regulacja1
      cpfseq      numer_opcji
      goto        wykryto_up_sprawdz_14
      
      
      incf        czy_reguluje1,f
      
      movlw      max_procedury_regu-1
      
      ; cpfseq      czy_reguluje1
      cpfsgt      czy_reguluje1
      goto         wykryto_up_sprawdz_13_dalej
      
      clrf              czy_reguluje1


      
wykryto_up_sprawdz_13_dalej
      lfsr      FSR2,czy_reguluje1
      call      wyswietl_opcje_regulacji
...
wykryto_up_sprawdz_14
      movlw       opcja_regulacja2
      cpfseq      numer_opcji
      goto        wykryto_up_sprawdz_15
      
      
      incf        czy_reguluje2,f
      ...
      cpfsgt      czy_reguluje2
      goto         wykryto_up_sprawdz_14_dalej
      
      clrf              czy_reguluje2
wykryto_up_sprawdz_14_dalej
      lfsr      FSR2,czy_reguluje2
      call      wyswietl_opcje_regulacji
...
wykryto_up_sprawdz_15 
      movlw      opcja_czujnik_regulacji1 
      cpfseq      numer_opcji
      goto        wykryto_up_sprawdz_16
      
      ;jezeli juz jest ustawiona ilosc czujnikow to zeruj
      
      movlw       ilosc_czujnikow-1
      subwf       ktory_czujnik_reguluje1,w
      ;jesli ktory czujnik jest wiekszy to C jest ustawione
      ; cpfsgt      ktory_czujnik_reguluje1
      
      
      btfss     STATUS,C
      goto        wykryto_up_sprawdz15_increase
      
      clrf        ktory_czujnik_reguluje1
      goto        wykryto_up_sprawdz15_show
      
wykryto_up_sprawdz15_increase      
      incf        ktory_czujnik_reguluje1,f
      
            
      
wykryto_up_sprawdz15_show      
      movf        ktory_czujnik_reguluje1,w
      movwf       tmp_hex
...
wykryto_up_sprawdz_16
      ...
      movlw       ilosc_czujnikow-1
      cpfsgt      ktory_czujnik_reguluje2
      goto        wykryto_up_sprawdz16_increase
      
      clrf        ktory_czujnik_reguluje2
      goto        wykryto_up_sprawdz16_show
      
wykryto_up_sprawdz16_increase      
      incf        ktory_czujnik_reguluje2,f
      
      
wykryto_up_sprawdz16_show      
      movf        ktory_czujnik_reguluje2,w
      movwf       tmp_hex
...
wykryto_up_sprawdz_20
;ustawienia zegara
      movlw       opcja_ustaw_zegar
      cpfseq      numer_opcji
      goto        wykryto_up_sprawdz_21
...
wykryto_up_sprawdz_20_1
      movlw       godziny_10
      cpfseq      ustawianie_czasu_co_wyswietlam
      goto        wykryto_up_sprawdz_20_2
      
      ;najpierw sprawdze czy godziny_1 i godziny_10 == 23 godzina bo wtedy wpisuje 00
      movlw       0x33
      cpfseq      godziny_1
      goto        sprawdz_zwiekszanie_godz_normal
      movlw       0x32
      cpfseq      godziny_10
      goto        sprawdz_zwiekszanie_godz_normal
...
sprawdz_zwiekszanie_godz_normal      
      movlw       0x39
      cpfseq      godziny_1
...
wykryto_up_sprawdz_20_2
      movlw       minuty_10
      cpfseq      ustawianie_czasu_co_wyswietlam
      goto        wykryto_up_sprawdz_20_3
...
wykryto_enter
      ...
      movf        pozycja_menu,w
      bnz         spr_czy_wchodze_do_zmiany_opcji
...
;;;; numery opcji odpowiadają 

;położeniu w menu      
      
spr_czy_wchodze_do_zmiany_opcji
      movlw       opcja_czujniki
      cpfseq      numer_opcji
...
wyswietl_temp_w_opcjach      
      movf        jaka_wartosc_regulujeL1,w
           ;dziele przez 4
      mullw       0x40
  ...
  ;teraz należy do adresu lini dodać miejsce położenia cyfry 100
      ...
      call        send
       ...
       call     wyswietl_cyfry_temperatury_opcje
...
wyswietl_temp_w_opcjach2      
      movf        jaka_wartosc_regulujeL2,w
...
wykryto_enter_sprawdz_opcje13
      ...
      ; btg         markers_regulacja,reguluj1
...
wykryto_enter_sprawdz_opcje14
      ...
      ; btg         markers_regulacja,reguluj2
...
wykryto_enter_sprawdz_opcje17      
      ...
      cpfseq      numer_opcji
      goto        wykryto_enter_sprawdz_opcje18
...
wykryto_enter_sprawdz_opcje18

      movlw       opcja_wyswietl_temp
      cpfseq      numer_opcji
      goto        wykryto_enter_sprawdz_opcje19
...
wykryto_enter_sprawdz_opcje19

      movlw       opcja_podswietlenie
      cpfseq      numer_opcji
      goto        wykryto_enter_sprawdz_opcje20
...
wykryto_enter_sprawdz_opcje20
      movlw       opcja_ustaw_zegar
      cpfseq      numer_opcji
      goto        wykryto_enter_sprawdz_opcje21
...
;;;;;;       kolejne opcje numery przy wyjsciu z nich
;;;;      
...
wykryto_enter_zmiana_opcji
      ...
      call     enter_back_wyjsc_z_opcji_czujnik
...
;opcja z liczbą      
      ...
      call  enter_back_wyjsc_z_op_wys_liczb
...
wykryto_enter_wyjscie_opcje6
      ...
      movlw       opcja_ustaw_temp_R2
      cpfseq      numer_opcji
      goto          wykryto_enter_wyjscie_opcje7
      call  enter_back_wyjsc_z_op_wys_liczb
...
wykryto_enter_wyjscie_opcje12
         movlw       opcja_histereza_R2_2
      cpfseq      numer_opcji
      goto          wykryto_enter_wyjscie_opcje13
      call  enter_back_wyjsc_z_op_wys_liczb
...
wykryto_enter_wyjscie_opcje13
        movlw       opcja_regulacja1
      cpfseq      numer_opcji
      goto          wykryto_enter_wyjscie_opcje14
      call  enter_back_wyjsc_z_op_wys_liczb
...
wykryto_enter_wyjscie_opcje14
        movlw       opcja_regulacja2
      cpfseq      numer_opcji
      goto          wykryto_enter_wyjscie_opcje15
      call  enter_back_wyjsc_z_op_wys_liczb
...
wykryto_enter_wyjscie_opcje15
      movlw       opcja_czujnik_regulacji1
      cpfseq      numer_opcji
      goto          wykryto_enter_wyjscie_opcje16
      call  enter_back_wyjsc_z_op_wys_liczb
...
wykryto_enter_wyjscie_opcje20
      movlw       opcja_ustaw_zegar
      cpfseq      numer_opcji
      goto        wykryto_enter_wyjscie_opcje21
...
odczytaj_adr_polozenia_gwiazdki
      movlw       HIGH tablica_gwiazdki
      movwf       TBLPTRH
...
wykr_enter_gdzie_wysw_licz_bajt
...
enter_back_wyjsc_z_opcji_czujnik
...
proc_wyswietl_kolej_liczb_zegara

      call  odczytaj_adr_polozenia_gwiazdki
      addlw       0x0c
      call        send
...
;która litera jest wyświetlana obok cyfr = D - day, H - hours, M - minute, S- seconds      
      movlw       dzien_10
      cpfseq      ustawianie_czasu_co_wyswietlam
      goto        wyswi_kolejnych_liczb_zegara_1
      movlw       _D
      goto        wysw_kolejnych_liczb_zegara_4
...
wyswi_kolejnych_liczb_zegara_1

      movlw       godziny_10
      cpfseq      ustawianie_czasu_co_wyswietlam
      goto        wysw_kolejnych_liczb_zegara_2
      movlw       _H
      goto        wysw_kolejnych_liczb_zegara_4
...
wysw_kolejnych_liczb_zegara_2

      movlw       minuty_10
      cpfseq      ustawianie_czasu_co_wyswietlam
      goto        wysw_kolejnych_liczb_zegara_3
      movlw       _M
      goto        wysw_kolejnych_liczb_zegara_4
...
enter_back_wyjsc_z_op_wys_liczb
...
tablica_pierwsza
      db   "pomiar t",0,"odstep",0,"srednia",0, "pomiar i" ,0
      
tablica_druga
      db    "ustaw t1",0,"ustaw t2",0,"wlacz1" ,0, "wlacz2" ,0
      
tablica_trzecia
      db     "his r1 1",0,"his r1 2",0x19,0,"his r2 1" ,0,"his r2 2" ,0
;,0x5e  - ^
tablica_czwarta
      db     "regulacja1",0,"regulacja2",0,"czuj r 1",0,"czuj r 2",0
      ;"przesyl serial",0
