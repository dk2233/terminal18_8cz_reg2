...
;         goto     wylacz_regulator
        ...
        movwf    jaka_wartosc_regulujeH1
         ...
         bsf      markers_regulacja,reguluj1
         goto     powrot_z_polecen    
...
;jezeli ostatni kanal to wyslij wszystkie, jezeli nie ostatni to zmierz kolejny
         btfss    markers_regulacja,reguluj1
...
;jezeli ostatni kanal to wyslij wszystkie, jezeli nie ostatni to zmierz kolejny
         btfss    markers_regulacja,reguluj2
...
sprawdz_czy_wlaczyc_szybka_zmiane3
      ...
      cpfseq      numer_opcji
      goto        sprawdz_czy_wlaczyc_szybka_zmiane4

      goto        ustaw_sprawdzanie_szybkiej_zmiany
      
sprawdz_czy_wlaczyc_szybka_zmiane4
      goto  wlacz_przerwanie_tmr3
...
; i nalezy zmienic pozycje_menu oraz wyswietlic opcje menu z kolejnego ekranu
      ...
      goto        wykryto_down_wyswietl_opcje_tablicy_piata
...
wykryto_down_sprawdz_6
      ...
      ;jeżeli w H jest 0 to  umieść tam 1
      movf       jaka_wartosc_regulujeH2,w
      bz          wykryto_down_sprawdz_6_zawracanie
      
      decf        jaka_wartosc_regulujeH2,f
      
      btfss       STATUS,Z
      goto        wykryto_down_sprawdz_6_zero
wykryto_down_sprawdz_6_zawracanie
      movlw       1
      movwf       jaka_wartosc_regulujeH2
...
;czujnik regulatora
      ...
      movf        ktory_czujnik_reguluje1,w
      btfss       STATUS,Z
      goto        wykryto_down_sprawdz15_nie_ma_zero
...
wykryto_down_sprawdz15_nie_ma_zero      
...
;czujnik regulatora
      ...
      movf        ktory_czujnik_reguluje2,w
      btfss       STATUS,Z
      goto        wykryto_down_sprawdz16_nie_ma_zero
...
; i następuje przeskok do ekranu menu 0 lub 1 
      ...
      btfss       STATUS,Z
      goto         wykryto_up_zmiana_polozenia_gwiazdki
...
;jeżeli będzie więcej ekrnów opcji menu, to tu należy dodać procedurę wykrywania adres której tablicy jest używany do wyświetlania opcji
      ...
      goto        wykryto_up_wyswietl_opcje_tablicy_cztery
      

      btfsc       pozycja_menu,menu_opcje5 
      ;(tj zaznaczony jet bit wskazujący na pokazywanie opcji ekranu 1, czyli przeskok do ekranu 0)
      goto        wykryto_up_wyswietl_opcje_tablicy_piata
...
wykryto_up_sprawdz_15 
      ...
      movlw       ilosc_czujnikow
      cpfseq      ktory_czujnik_reguluje1
...
wykryto_up_sprawdz_16
      ...
      movlw       ilosc_czujnikow
      cpfseq      ktory_czujnik_reguluje2
